        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (focusChange == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    audio = MediaPlayer.create(PhrasesActivity.this, word.getAudioFile());
            ...
            new AudioManager.OnAudioFocusChangeListener() {
                public void onAudioFocusChange(int focusChange) {
                    if (focusChange == AudioManager.AUDIOFOCUS_LOSS_TRANSIENT) {
                        ...
                        Toast.makeText(PhrasesActivity.this, "AUDIOFOCUS_LOSS_TRANSIENT", Toast.LENGTH_SHORT).show();
                        audio.pause();
                        audio.seekTo(0);
                        ...
                        // are finished
                        Toast.makeText(PhrasesActivity.this, "AUDIOFOCUS_GAIN", Toast.LENGTH_SHORT).show();
